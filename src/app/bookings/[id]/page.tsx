...
export default async function BookingDetailPage({
  ...
  const serialized = {
    ...
    service: {
      ...
      isSolidarityMission: booking.service.isSolidarityMission,
      solidarityStatus: booking.service.solidarityStatus,
      solidarityCategory: booking.service.solidarityCategory,
    },
    client: {
